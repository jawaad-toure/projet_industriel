...
<div class="container">
    ...
    <div class="d-flex flex-column align-items-center">
        ...
        <form 
            method="POST" 
            action="{{ route('user.informations.update', ['userId' => session()->get('user')['id']]) }}" 
        ...
        >
            ...
            <div class="row row-cols-md-2 gx-2 mb-3">
                <div class="form-group my-2">
                    ...
                    <input 
                        ...
                        class="py-3 form-control shadow-none @error('firstname') is-invalid @enderror" 
                    /> 
                ...
                <div class="form-group my-2">
                    ...
                    <input 
                        ...
                        class="py-3 form-control shadow-none @error('lastname') is-invalid @enderror" 
                    /> 
            ...
            <div class="row row-cols-md-2 gx-2 mb-3">
                <div class="form-group my-2">
                    ...
                    <input 
                        ...
                        id="birthdate" 
                        name="birthdate" 
                        value="{{session()->get('user')['birthdate']}}"
                        aria-describedby="birthdate_feedback" 
                        class="py-3 form-control shadow-none @error('birthdate') is-invalid @enderror" 
                    /> 
            ...
            <div class="row row-cols-md-2 gx-2 mb-3">
                ...
                <div class="form-group my-2">
                    ...
                    <input 
                        ...
                        placeholder="+33 07 00 00 00 00"
                        aria-describedby="phone_feedback" 
                        class="py-3 form-control shadow-none @error('phone') is-invalid @enderror" 
                    /> 
            ...
            <div class="form-group my-2 mb-3">
                ...
                <input 
                    ...
                    placeholder="00 rue Nom de la rue"
                    aria-describedby="address_feedback" 
                    class="py-3 form-control shadow-none @error('address') is-invalid @enderror" 
                /> 
            ...
            <div class="row row-cols-md-3 gx-2 mb-3">
                ...
                <div class="form-group my-2">
                    ...
                    <input 
                        ...
                        aria-describedby="new_password_feedback" 
                        class="py-3 form-control shadow-none @error('new_password') is-invalid @enderror" 
                    />  
            ...
            <div class="form-group my-2 mb-3">
                ...
                <input 
                    ...
                    accept="image/*"
                    aria-describedby="profile_picture_feedback" 
                    class="py-3 form-control shadow-none @error('profile_picture_feedback') is-invalid @enderror" 
                /> 
            ...
            <div class="d-flex gap-2">
                ...
                <a 
                    class="flex-fill btn btn-secondary btn-lg" 
                    href="{{ route('user.dashboard.show', ['userId' => session()->get('user')['id']]) }}" 
                    role="button"
                >
                    Retour
                </a>
