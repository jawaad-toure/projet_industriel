...
<body>
    <div class="container">
        <div class="d-flex flex-column m-4 gap-3">
            ...
            <div>
                Vous avez recevez cet email parce que vous avez demandé à modifier votre addresse email.
            </div>

            <div>
                Veuillez cliquer sur le bouton ci-dessous pour valider votre nouvelle adresse email.
            </div>
