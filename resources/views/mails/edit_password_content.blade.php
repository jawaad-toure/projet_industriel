...
<body>
    <div class="container">
        <div class="d-flex flex-column m-4 gap-3">
            ...
            <div>
                Vous avez recevez cet email parce que vous avez demandé à changer votre mot de passe.
            </div>
            ...
            <div>
                <a href="{{ route('editPassword.show', ['userId' => $editPasswordUserId]) }}" role="bouton" class="btn btn-primary">
